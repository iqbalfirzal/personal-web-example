...
<?php
	...
	while (false !== ($file = readdir($dh))) {
		...
		{
			echo"<tr><td>$no</td><td style='text-align:left;'>$file</td><td><a href='../!down?loc=ft&file=$file'><img src='../img/download.png' height='30px'></a></td><td><a href='../!del.php?loc=ft&del=$file'><img src='../img/delete.png' height='30px'></a></td></tr>";
			$no++;
		}
	}
	echo"</table>";
